...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    //setup jenis data yang dibutuhkan
    ...
    if (!empty($feedback)) {
        ...
        echo "feedback wajib di isi";
        exit();
    }
}

//melakukan pengecekan ada isinya  / kosong = inpit tertera
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard-petugas.php">
                ...
                <div class="sidebar-brand-text mx-3">BaikiAja</div>
            </a>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-success">From Tambah Feedback untuk laporan dengan data <?= $report_id ?></h6>
                                </div>
